Commands on Assembly Files
==========================

``act`` contains commands for manipulating individual assembly files and
assembly litmus tests.  We group these together under the ``act asm``
command group.
