...
module Record: sig
  ...
  (** [is_global r] gets whether [r]'s variable has been mapped into the global
      scope. *)
end
...
val globally_unmapped_vars : t -> (Act_common.Litmus_id.t, Record.t) List.Assoc.t
val globally_mapped_vars : t -> (Act_common.Litmus_id.t, Record.t) List.Assoc.t
