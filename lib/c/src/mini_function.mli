...
val make :
     parameters:(Act_common.C_id.t, Mini_type.t) List.Assoc.t
  -> body_decls:(Act_common.C_id.t, Mini_initialiser.t) List.Assoc.t
  -> ?body_stms:Mini_statement.t list
  -> unit
  -> t
...
val parameters : t -> (Act_common.C_id.t, Mini_type.t) List.Assoc.t
(** [parameters func] gets [func]'s parameter list. *)

val body_decls : t -> (Act_common.C_id.t, Mini_initialiser.t) List.Assoc.t
(** [body_decls func] gets [func]'s in-body variable declarations. *)

val body_stms : t -> Mini_statement.t list
...
val with_body_stms : t -> Mini_statement.t list -> t
...
val map :
     t
  -> parameters:(   (Act_common.C_id.t, Mini_type.t) List.Assoc.t
                 -> (Act_common.C_id.t, Mini_type.t) List.Assoc.t)
  -> body_decls:(   (Act_common.C_id.t, Mini_initialiser.t) List.Assoc.t
                 -> (Act_common.C_id.t, Mini_initialiser.t) List.Assoc.t)
  -> body_stms:(Mini_statement.t list -> Mini_statement.t list)
  -> t
...
module On_monad (M : Monad.S) : sig
  val map_m :
       t
    -> parameters:(   (Act_common.C_id.t, Mini_type.t) List.Assoc.t
                   -> (Act_common.C_id.t, Mini_type.t) List.Assoc.t M.t)
    -> body_decls:(   (Act_common.C_id.t, Mini_initialiser.t) List.Assoc.t
                   -> (Act_common.C_id.t, Mini_initialiser.t) List.Assoc.t
                      M.t)
    -> body_stms:(Mini_statement.t list -> Mini_statement.t list M.t)
    -> t M.t
end
