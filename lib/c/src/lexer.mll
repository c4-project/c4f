...
| "/*" { Act_utils.Lex_utils.skip_c_comment lexbuf ; token typedefs lexbuf }
| "//" { Act_utils.Lex_utils.skip_c_line_comment lexbuf ; token typedefs lexbuf }
...
| eof { EOF }
| _ { Act_utils.Frontend.lex_error ("Unexpected char: " ^ lexeme lexbuf) lexbuf }
