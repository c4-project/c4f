...
let%test_module "Sync_surround" =
  ( module struct
    module Surround = Src.Lock_actions.Sync_surround
    ...
    let action =
      Surround.run test
        ~payload:(Lazy.force Subject.Test_data.Path.surround_atomic)
...
let%test_module "Atomic_surround" =
  ( module struct
    module Surround = Src.Lock_actions.Atomic_surround
    ...
    let action =
      Surround.run test
        ~payload:(Lazy.force Subject.Test_data.Path.surround_txsafe)
